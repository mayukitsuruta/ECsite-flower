        ...
        <ShopLayout wide>
            ...
            <Box className="grid gap-10 lg:grid-cols-2">
                ...
                <Box>
                    ...
                    <p className="mt-1 font-serif text-xl text-bloom-800">
                    ...
                    {flower.color && (
                        <Box className="mt-3 flex items-center gap-2">
                            <span
                                ...
                                style={{
                                    backgroundColor: flower.color_hex ?? "#ccc",
                                }}
                            />
                    ...
                    <form
                        onSubmit={addToCart}
                        className="mt-8 flex flex-wrap items-end gap-4 border-t border-stone-200 pt-8"
                    >
                        <Box>
                    ...
                    {showMessageCard && (
                        <form
                            onSubmit={addMessageCard}
                            className="mt-6 rounded-xl border border-stone-200 bg-stone-50 p-5"
                        >
                            ...
                            <textarea
                                ...
                                onChange={(e) =>
                                    cardForm.setData("message", e.target.value)
                                }
                                rows={3}
                                maxLength={200}

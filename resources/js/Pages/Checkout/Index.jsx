            ...
            <form onSubmit={submit} className="grid gap-10 lg:grid-cols-3">
                <div className="space-y-6 lg:col-span-2">
                    <fieldset className="rounded-xl border border-bloom-100 bg-white p-6">
                        <legend className="px-2 font-medium text-bloom-800">
                            受け取り方法
                        </legend>
                        <label className="mt-4 flex cursor-pointer items-center gap-3">
                            <input
                                ...
                                onChange={() =>
                                    form.setData("fulfillment_type", "pickup")
                                }
                        ...
                        <label className="mt-3 flex cursor-pointer items-center gap-3">
                            <input
                                ...
                                onChange={() =>
                                    form.setData("fulfillment_type", "delivery")
                                }
                                className="text-bloom-600 focus:ring-bloom-500"
                            />
                    ...
                    {form.data.fulfillment_type === "pickup" && (
                        <fieldset className="rounded-xl border border-bloom-100 bg-white p-6">
                            ...
                            <select
                                ...
                                onChange={(e) =>
                                    form.setData("pickup_store", e.target.value)
                                }
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    form.setData("pickup_at", e.target.value)
                                }
                    ...
                    <fieldset className="rounded-xl border border-bloom-100 bg-white p-6">
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                form.setData("recipient_phone", e.target.value)
                            }
                            className="mt-1 w-full rounded-lg border-bloom-200"
                            required
                        />

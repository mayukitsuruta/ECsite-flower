        ...
        <ShopLayout>
            ...
            <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-bloom-100 via-white to-sage-100 px-6 py-16 sm:px-12 sm:py-20">
                <div className="relative z-10 max-w-2xl">
                    ...
                    <div className="mt-8 flex flex-wrap gap-3">
                        <Link href={route('bouquet.builder')} className="btn-primary">
                            花束を作る
                        </Link>
                        <Link href={route('flowers.index')} className="btn-secondary">
                            Shop — 花を選ぶ
                        </Link>
                    </div>
                </div>
            ...
            <section className="mt-16">
                <div className="mb-8 flex items-end justify-between">
                    <div>
                        <h2 className="font-serif text-2xl text-bloom-900">この季節のおすすめ</h2>
                        <p className="mt-1 text-sm text-stone-500">季節の花で、今の想いを伝えましょう</p>
                    </div>
                    <Link href={route('flowers.index', { seasonal: 1 })} className="text-sm text-bloom-600 hover:underline">
                        すべて見る →
                    </Link>
                </div>
            ...
            <section className="mt-16 rounded-2xl border border-sage-200 bg-sage-50 p-8">
                <h2 className="font-serif text-xl text-sage-700">想い束の3つの特徴</h2>
